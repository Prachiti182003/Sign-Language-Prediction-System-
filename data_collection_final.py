...
count = len(oss.listdir("C:/Users/Admin/OneDrive/Desktop/Sign-Language-To-Text-and-Speech-Conversion-master/AtoZ_3.1/A/"))
c_dir = 'A'
offset = 15
step = 1
flag=False
...
cv2.imwrite("C:/Users/Admin/OneDrive/Desktop/Sign-Language-To-Text-and-Speech-Conversion-master/white.jpg",white)
    ...
    try:
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            if ord(c_dir)==ord('Z')+1:
                c_dir='A'
            flag = False
            count = len(oss.listdir("C:/Users/Admin/OneDrive/Desktop/Sign-Language-To-Text-and-Speech-Conversion-master/AtoZ_3.1/" + (c_dir) + "\\"))
        ...
        if flag==True:
            ...
            if suv==180:
                flag=False
            if step%3==0:
                cv2.imwrite("C:/Users/Admin/OneDrive/Desktop/Sign-Language-To-Text-and-Speech-Conversion-master/AtoZ_3.1/" + (c_dir) + "\\" + str(count) + ".jpg",
                            skeleton1)
