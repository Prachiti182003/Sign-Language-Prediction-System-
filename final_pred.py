...
import os, sys
import sys
sys.path.append("C:/Users/Admin/OneDrive/Desktop/Sign-Language-To-Text-and-Speech-Conversion-master/translate.py")  # Ensure the correct path to transate.py

from translate import translate_text, create_translator_gui
...
class Application:
    ...
    def __init__(self):
        ...
        self.speak.place(x=1005, y=530)
        self.speak.config(text="Speak", font=("Courier", 20), wraplength=100, command=self.speak_fun)

        self.clear = tk.Button(self.root)
        self.clear.place(x=880, y=530)
        self.clear.config(text="Clear", font=("Courier", 20), wraplength=100, command=self.clear_fun)

        # Translate Button
        self.translate_btn = tk.Button(self.root, text="Translate", font=("Courier", 20), bg="orange",
                                       command=self.open_translator)
        self.translate_btn.place(x=680,y=530)
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread("C:/Users/Admin/OneDrive/Desktop/Sign-Language-To-Text-and-Speech-Conversion-master/white.jpg")
                # img_final=img_final1=img_final2=0
    ...
    def open_translator(self):
        create_translator_gui()  # Opens the translator window
