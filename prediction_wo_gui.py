...
model = load_model('C:/Users/Admin/OneDrive/Desktop/Sign-Language-To-Text-and-Speech-Conversion-master/cnn8grps_rad1_model.h5')
    ...
    try:
        ...
        if hands:
            ...
            if isinstance(hand, list) and len(hand) > 0:
                ...
                print("Hand data is empty or not in expected format")
